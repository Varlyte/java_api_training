...
public class PostHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        String request = "{\"id\":\"0c575465-21f6-43c9-8a2d-bc64c3ae6241\", \"url\":\"http://localhost:8796\", \"message\":\"I will Crush You !!\"}";
        String response = "empty";
        if (exchange.getRequestMethod().equals("POST")) {
            response = "{\"id\":\"2aca7611-0ae4-49f3-bf63-75bef4769028\", \"url\":\"http://localhost:8796\", \"message\":\"May the best code win\"}";
